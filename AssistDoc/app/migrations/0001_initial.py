# Generated by Django 5.2.4 on 2025-07-19 20:33
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="consultations", to="app.constant"
                    ),
                ),
                (
                    "hospital",
                    models.ForeignKey(
                        ...
                        related_name="consultations_hospital",
                        to="app.hospital",
                    ),
                ),
                (
                ...
                (
                    "symptoms",
                    models.ManyToManyField(
                        blank=True, related_name="consultations", to="app.symptom"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="diagnostics_associes",
                        to="app.consultation",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="diagnostics_hopital",
                        to="app.hospital",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text="The groups this user belongs to. A user will get all permissionsgranted to each of their groups.",
                ...
                (
                    "hospitals",
                    models.ManyToManyField(related_name="doctors", to="app.hospital"),
                ),
                (
                    "user_permissions",
                    models.ManyToManyField(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="prescriptions_associees",
                        to="app.consultation",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="prescriptions_hopital",
                        to="app.hospital",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="prescriptions_faites",
                        to="app.user",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fichier_imagerie",
                    models.FileField(
                        blank=True, null=True, upload_to="medical_imaging/"
                    ),
                ),
                (
                    "hopital",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="imageries_medicales_hopital",
                        to="app.hospital",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="imageries_medicales",
                        to="app.patient",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="imageries_prescrites",
                        to="app.user",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="examens_laboratoire_hopital",
                        to="app.hospital",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="examens_laboratoire",
                        to="app.patient",
                    ),
                ),
                (
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="diagnostics_poses",
                to="app.user",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="performed_consultations",
                to="app.user",
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Score de confiance de l'IA pour cette recommandation (0-100%)",
                        max_digits=5,
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="ai_recos_from_consult",
                        to="app.consultation",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="ai_recos_from_diag",
                        to="app.diagnostic",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="ai_recos_from_lab",
                        to="app.examenlaboratoire",
                    ),
                ),
                (
                    "patient",
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="received_ai_recommendations",
                        to="app.user",
                    ),
                ),
            ],
